    ...
    pub mod na_packet {
        ...
        mod tests {
            ...
            fn test_valid_src_ip_address_arp(){
                let packet = [255, 255, 255, 255, 255, 255, 16, 19, 49, 214, 140, 202, 8, 6, 0, 1, 8, 0, 6, 4, 0, 1, 16, 19, 49, 214, 140, 202, 192, 168, 1, 254, 0, 0, 0, 0, 0, 0, 192, 168, 1, 231];
            ...
            fn test_valid_src_ipv6_address(){
                let packet = [144, 156, 74, 210, 12, 51, 16, 19, 49, 214, 140, 202, 134, 221, 104, 13, 1, 33, 0, 32, 6, 123, 42, 0, 20, 80, 64, 19, 12, 7, 0, 0, 0, 0, 0, 0, 0, 188, 32, 1, 11, 7, 10, 150, 30, 12, 172, 137, 153, 5, 61, 147, 27, 58, 20, 108, 220, 159, 19, 96, 56, 166, 80, 187, 215, 91, 128, 16, 1, 9, 114, 40, 0, 0, 1, 1, 8, 10, 115, 22, 6, 117, 43, 14, 124, 156];
